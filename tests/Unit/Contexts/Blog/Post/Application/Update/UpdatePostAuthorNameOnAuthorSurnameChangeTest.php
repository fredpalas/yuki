...
use App\Contexts\Blog\Post\Application\Update\UpdatePostAuthorNameOnAuthorSurnameChange;
...
class UpdatePostAuthorNameOnAuthorSurnameChangeTest extends UnitTestCase
{
    private UpdatePostAuthorNameOnAuthorSurnameChange $updater;
    ...
    protected function setUp(): void
    {
        ...
        $this->updater = new UpdatePostAuthorNameOnAuthorSurnameChange(
    ...
    public function testShouldUpdateAuthorNameInPosts(): void
    {
        ...
        $event = new AuthorSurnameUpdatedDomainEvent(
            $author->id->value(),
            $surname,
